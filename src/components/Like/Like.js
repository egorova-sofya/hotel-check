...
import { updateFeaturedHotel } from "../../Redux/reducers/getHotelsReducer";
...
const Like = ({ item }) => {
  ...
  return (
    <div
      onClick={() => {
        // setLike(!like);
        dispatch(updateFeaturedHotel(!item.featured, item));
      }}
    ...
    >
      ...
      >
        <path
          ...
          fill={item.featured ? "#e55858" : "white"}
          stroke={item.featured ? "#e55858" : "#C4C4C4"}
          strokeLinecap="round"
